...
--
-- Host: localhost:3306
-- Generation Time: 12-Abr-2019 às 18:08
...
INSERT INTO `video` (`codvideo`, `path`, `name`, `question`, `opt1`, `opt1path`, `opt2`, `opt2path`) VALUES
(1, 'v1.mp4', 'Video 1', 'Aquilo?', 'Isto', 'v2.mp4', 'Isto 2', 'v3.mp4'),
(2, 'v2.mp4', 'Video 2', 'Porque?', 'Porque sim', 'v4.mp4', 'Porque não', 'v5.mp4');
