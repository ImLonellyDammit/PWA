...
<html lang="pt-PT">
    ...
    <body data-spy="scroll" data-target=".navbar" data-offset="1">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarToggler">
                   <ul class="navbar-nav">
                        ...
                        <li>
                            <a class="navbar-item" href="#equipa">Equipa</a>
                        </li>
                        <li>
                            <a class="navbar-item" href="#making">Making-Off</a>
                        </li>
                        <li>
                            <a class="navbar-item" href="#marketing">Marketing</a>
                        </li>
                        <li>
       ...
       <!-- Equipa -->
        <div id="equipa" class="container-fluid bg-white">
                <div class="pt-5 pb-5 text-center container text-dark">
                <h1>Equipa</h1>                        
        ...
        <section id="making">
            <div class="pb-5 pt-5 text-center container-fluid text-white">
                ...
                <div class="row justify-content-md-center align-content-center pb-3">
                    <div class="embed-responsive embed-responsive-16by9 col-md-11 ml-2 mr-2">
                        <iframe class="embed-responsive-item pb-2" src="https://www.youtube.com/embed/iaEi7Mxith0"></iframe>
                    </div>
                </div>
            </div>
        </section>
